<h1 align="center">Prakash</h1>
<h3 align="center">Building Scalable Web & Mobile Experiences</h3>

---

## 🙋‍♂️ About Me

- Full Stack Developer building scalable **Web** and **Mobile** applications.<br/>
- Focused on clean UI, performance, and maintainable architecture.<br/>
- Build cross-platform mobile apps with **React Native & Expo**.<br/>
- Web & backend experience with **React, .NET MVC/Core, REST APIs & MySQL**.<br/>
- Constant learner exploring modern frameworks and system design.<br/>
- Reach me at: **impcakash@gmail.com**
